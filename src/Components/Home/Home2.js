        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple"> Python, React-Native. </b>
              </i>
              <br />
              <br />
              My interest in Data Science,
              <i>
                <b className="purple"> Machine learning technology </b> and
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/kishan-kumar-76ab151ab/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/kishan_k_prajapati/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
